const playdate_platform = @import("playdate_platform_main.zig");
...
export var PD_eventHandler: *const fn (playdate: *pdapi.PlaydateAPI, event: pdapi.PDSystemEvent, arg: u32) callconv(.C) c_int linksection(".capi_handler") = playdate_platform.eventHandler;
